CLASS zbp_017x_r_travel_class DEFINITION PUBLIC ABSTRACT FINAL FOR BEHAVIOR OF z017_r_travel.
ENDCLASS.

CLASS zbp_017x_r_travel_class IMPLEMENTATION.
ENDCLASS.
...
CLASS lhc_item IMPLEMENTATION.
  ...
  CONSTANTS c_area TYPE string VALUE `CLASS`.
    ...
    READ ENTITIES OF Z017_R_TRAVEL IN LOCAL MODE
      ENTITY item
      FIELDS ( agencyid travelid ZZClassZ99 )
    ...
    LOOP AT items ASSIGNING FIELD-SYMBOL(<item>).
      ...
      IF <item>-ZZClassZ99 IS INITIAL.
        ...
        APPEND VALUE #( %tky = <item>-%tky
                        ...
                        %element-ZZClassZ99 = if_abap_behv=>mk-on
                        %state_area = c_area
...
CLASS lsc_Z017_R_TRAVEL IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    LOOP AT items ASSIGNING FIELD-SYMBOL(<item>)
   WHERE %control-ZZClassZ99 = if_abap_behv=>mk-on.
      UPDATE z017_tritem SET zzclassz99 = @<item>-ZZClassZ99 WHERE item_uuid = @<item>-ItemUuid.
    ENDLOOP.
  ENDMETHOD.
