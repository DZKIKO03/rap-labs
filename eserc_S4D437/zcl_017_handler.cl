CLASS zcl_017_handler DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC FOR EVENTS OF z017_r_travel .
...
CLASS zcl_017_handler IMPLEMENTATION.
ENDCLASS.
...
*                      TravelID = <travel>-TravelId Origin = 'Z017_R_TRAVEL' ) TO log.
*    ENDLOOP.
