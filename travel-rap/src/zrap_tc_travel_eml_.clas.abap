"! @testing BDEF:ZR_TRAVEL_TAB
CLASS zrap_tc_travel_eml_ DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zrap_tc_travel_eml_ IMPLEMENTATION.
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zr_travel_tab
     ENTITY Travel
    ...
    SELECT * FROM zr_travel_tab INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
