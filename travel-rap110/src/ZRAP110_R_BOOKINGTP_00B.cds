...
@ObjectModel.sapObjectNodeType.name: 'ZRAP110_Booking_00B'
define view entity ZRAP110_R_BOOKINGTP_00B
  as select from ZRAP110_ABOOK00B as Booking
  association to parent ZRAP110_R_TRAVELTP_00B as _Travel on $projection.TravelID = _Travel.TravelID
