CLASS zrap110_calc_trav_elem_00b DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  calculate_trav_status_ind
    IMPORTING is_original_data TYPE ZRAP110_C_TravelTP_00B
    RETURNING VALUE(result)    TYPE ZRAP110_C_TravelTP_00B.

  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.

CLASS ZRAP110_CALC_TRAV_ELEM_00b IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'OVERALLSTATUSINDICATOR'.
          DATA lt_trav_original_data TYPE STANDARD TABLE OF ZRAP110_C_TravelTP_00b WITH DEFAULT KEY.
          ...
          LOOP AT lt_trav_original_data ASSIGNING FIELD-SYMBOL(<fs_trav_original_data>).
            ...
            <fs_trav_original_data> = zrap110_calc_trav_elem_00B=>calculate_trav_status_ind( <fs_trav_original_data> ).
  ...
  METHOD if_sadl_exit_calc_element_read~get_calculation_info.
    IF iv_entity EQ 'ZRAP110_C_TRAVELTP_OOB'. "Travel BO node
