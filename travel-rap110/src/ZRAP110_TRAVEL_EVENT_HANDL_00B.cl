class ZRAP110_TRAVEL_EVENT_HANDL_00B definition
  public
  final FOR EVENTS OF ZRAP110_R_TRAVELTP_00B
  create public .
...
CLASS ZRAP110_TRAVEL_EVENT_HANDL_00B IMPLEMENTATION.
ENDCLASS.
...
CLASS lhe_travel IMPLEMENTATION.
  ...
  METHOD on_travel_accepted.
    ...
    LOOP AT accepted REFERENCE INTO DATA(lr_accepted).
      DATA lr_travel_accepted TYPE zrap110_etrav00B.
      ...
      "insert to db
      INSERT zrap110_etrav00B FROM @lr_travel_accepted.
    ENDLOOP.
  ...
  METHOD on_travel_rejected.
    ...
    LOOP AT rejected REFERENCE INTO DATA(lr_rejected).
      DATA lr_travel_rejected TYPE zrap110_etrav00B.
      ...
      "insert to db
      INSERT zrap110_etrav00B FROM @lr_travel_rejected.
    ENDLOOP.
  ENDMETHOD.
